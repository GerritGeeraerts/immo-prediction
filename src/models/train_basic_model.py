...
columns_to_keep = ['Bathroom Count', 'Bedroom Count', 'Habitable Surface', 'Land Surface', 'Price']
...
# standard scaler
standard_scaler = MyStandardScaler(columns_to_scale=['Bathroom Count', 'Bedroom Count', 'Habitable Surface', 'Land Surface'])
...
save_model_as_pickle(reg_model, '../../models/basic_model.pkl')
